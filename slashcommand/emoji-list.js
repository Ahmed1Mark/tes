...
module.exports = {
    name: 'emoji-list',
    description: 'List all static and animated emojis in the server',
    ...
    execute: async (interaction) => {
        ...
        for (const chunk of staticEmojiChunks) {
            ...
            if (isFirstOverallEmbed) {
                embed.setFooter({ text: `Static Emojis: ${staticEmojisCount}, Animated Emojis: ${animatedEmojisCount}, Total: ${totalEmojisCount}` })
